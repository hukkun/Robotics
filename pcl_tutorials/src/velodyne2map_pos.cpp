...
lidarLCL::lidarLCL(ros::NodeHandle& n){
	lidar_sub = n.subscribe("/human_recognition/positive_position", 1, &lidarLCL::lidarCallback, this);
	lidar_pub = n.advertise<sensor_msgs::PointCloud2>("/human_recognition/positive_position/lcl", 1);
}
...
int main(int argc, char **argv){
	ros::init(argc, argv, "velodyne2map_pos");
	ros::NodeHandle n;
