...
lidarLCL::lidarLCL(ros::NodeHandle& n){
	// lidar_sub = n.subscribe("/dynamic_cluster/points", 1, &lidarLCL::lidarCallback, this);
	lidar_sub = n.subscribe("/cluster/points", 1, &lidarLCL::lidarCallback, this);
	lidar_pub = n.advertise<sensor_msgs::PointCloud2>("/dynamic_cluster/points/lcl", 1);
}
...
int main(int argc, char **argv){
	ros::init(argc, argv, "centerlaser2odom_pt");
	ros::NodeHandle n;
